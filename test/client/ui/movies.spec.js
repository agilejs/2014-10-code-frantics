...
describe('Movies', function() {
    ...
    it('should add movies and forward to the detail view', function() {
        newMovie.addActor('The Dark Knight', 'When Batman, Gordon and Harvey Dent ' +
        ...
        newMovie.addActor('The Dark Knight Rises', 'Eight years on, a new evil rises ' +
        ...
        newMovie.addActor('Cloud Atlas', 'An exploration of how the actions of ' +
            ...
            'revolution.');
        newMovie.addActor('Ted', 'As the result of a childhood wish, John Bennett\'s ' +
        ...
        newMovie.addActor('The Meerkats', 'An inspiring exploration of one family\'s ' +
            'resilience and fortitude shot using innovative and ' +
            'groundbreaking filming techniques.');
        newMovie.addActor('Undisputed II: Last Man Standing', 'Sequel to the 2002 ' +
